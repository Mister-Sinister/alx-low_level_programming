...
File 10-print_triangle.c is a function that prints a triangle, followed by a new lineFile 0-isupper.c is a function that checks for uppercase character.
